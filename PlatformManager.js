...
export default class PlatformManager {
    constructor(gameWidth, gameHeight) {
        ...
        // Define some static platforms
        this.platforms = [
            { x: 300, y: gameHeight - 120, width: 96, height: 8 }, 
            { x: 600, y: gameHeight - 120, width: 96, height: 8 },
            { x: 750, y: gameHeight - 200, width: 96, height: 8 },
            { x: 1000, y: gameHeight - 120, width: 128, height: 8 },
            { x: 1400, y: gameHeight - 150, width: 96, height: 8 },
            { x: 1800, y: gameHeight - 120, width: 96, height: 8 },
            { x: 2000, y: gameHeight - 200, width: 96, height: 8 },
            { x: 2300, y: gameHeight - 120, width: 96, height: 8 }
        ];
    }
