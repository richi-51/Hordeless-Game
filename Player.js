...
export default class Player {
  constructor(gameWidth, gameHeight, game) {
    ...
    this.sprites = {
      normal: {
        ...
        djump: new Sprite(
          `${basePath}/Double Jump (32x32).png`,
          32,
          32,
          6,
          0.05,
      ...
      rex: {
        idle: new Sprite(
          "/Assets/Free/Bosses_Dino_Rex/Dino Rex/dino_rex_idle.png",
          128,
          128,
          5,
          0.1,
        ...
        run: new Sprite(
          "/Assets/Free/Bosses_Dino_Rex/Dino Rex/dino_rex_move.png",
          384,
          128,
          8,
          0.05,
        ...
        attack: new Sprite(
          "/Assets/Free/Bosses_Dino_Rex/Dino Rex/dino_rex_attack_A.png",
          384,
          128,
          21,
          0.05,
      ...
      tri: {
        idle: new Sprite(
          "/Assets/Free/Bosses_Dino_Tri/Dino Tri/dino_tri_idle.png",
          384,
          128,
          6,
          0.1,
        ...
        run: new Sprite(
          "/Assets/Free/Bosses_Dino_Tri/Dino Tri/dino_tri_move.png",
          384,
          128,
          8,
          0.05,
        ...
        attack: new Sprite(
          "/Assets/Free/Bosses_Dino_Tri/Dino Tri/dino_tri_attack_A.png",
          384,
          128,
          21,
          0.05,
        ), // Capped at 21 frames (8064 pixels) to prevent 8192 browser texture limit cut off
      },
      pengu: {
        idle: new Sprite(
          "/Assets/Free/Bosses_Pengu/Pengu/pengu_idle.png",
          128,
          128,
          5,
          0.1,
        ...
        run: new Sprite(
          "/Assets/Free/Bosses_Pengu/Pengu/pengu_move.png",
          384,
          128,
          8,
          0.05,
        ...
        attack: new Sprite(
          "/Assets/Free/Bosses_Pengu/Pengu/pengu_attack_peck.png",
          384,
          128,
          11,
          0.05,
  ...
  applyUpgrades(upgrades) {
    ...
    else if (upgrades.speed >= 3) speedMultiplier = 1.1;
  ...
  draw(ctx, cameraX) {
    ...
    if (!this.isDying && Player.shadowImage && Player.shadowImage.complete) {
      ctx.drawImage(
        Player.shadowImage,
        this.x + this.width / 2 - 16 - cameraX,
  ...
  update(input, deltaTime, effects) {
    ...
    if (input.keys.attack && !this.isAttacking && this.form !== "normal") {
      ...
      this.attackTimer =
        this.sprites[this.form].attack.frameCount *
        this.sprites[this.form].attack.frameDuration;
    ...
    if (input.jumpBufferCounter > 0) {
      const onOneWayPlatform = solids.some(
        (solid) =>
          solid.oneWay &&
          this.x < solid.x + solid.width &&
          this.x + this.width > solid.x &&
    ...
    const currentLevelData =
      this.game?.currentLevelIndex !== undefined && window.Levels
        ? window.Levels[this.game.currentLevelIndex]
        : null;
    let overGap = false;
    if (currentLevelData && currentLevelData.gaps) {
      const playerCenterX = this.x + this.width / 2;
      overGap = currentLevelData.gaps.some(
        (gap) => playerCenterX > gap.x && playerCenterX < gap.x + gap.width,
      );
    }
    ...
    if (this.isAttacking) {
      ...
      this.invulnerableTimer > 0 &&
      this.invulnerableTimer > this.invulnerableDuration - 0.3 &&
      this.form === "normal"
    ) {
