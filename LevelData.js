export const Levels = [
    ...
    },
    {
        ...
        length: 4000,
        platforms: [
            { x: 400, y: 240, width: 64, height: 32 }, // thick solid platforms
            { x: 600, y: 160, width: 64, height: 32 },
            { x: 900, y: 240, width: 128, height: 32 },
            { x: 1300, y: 100, width: 64, height: 32 },
            { x: 1600, y: 200, width: 64, height: 32 },
            { x: 1900, y: 240, width: 128, height: 32 },
            { x: 2300, y: 140, width: 64, height: 32 },
            { x: 2800, y: 240, width: 128, height: 32 },
            { x: 3300, y: 180, width: 96, height: 32 }
        ],
        boxes: [
            { x: 610, y: 100 },
            { x: 1920, y: 150 },
    ...
    },
    {
        ...
        length: 5000,
        platforms: [
            { x: 300, y: 200, width: 32, height: 128 }, // tall walls for wall jump
            { x: 600, y: 150, width: 32, height: 128 },
            { x: 1000, y: 250, width: 96, height: 8 },
            { x: 1400, y: 150, width: 96, height: 8 },
            { x: 1800, y: 200, width: 32, height: 128 },
            { x: 2200, y: 100, width: 32, height: 128 },
            { x: 2600, y: 240, width: 64, height: 8 },
            { x: 3200, y: 150, width: 64, height: 8 },
            { x: 3800, y: 200, width: 32, height: 128 },
